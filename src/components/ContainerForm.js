    ...
    <div className={styles.rectangleParent}>
      ...
      <div className={styles.groupParent}>
        <div className={styles.uileditParent}>
          <img className={styles.uileditIcon} alt="" src="/uiledit.svg" />
          <img
        ...
        <div className={styles.uileditGroup}>
          <img className={styles.uileditIcon1} alt="" src="/uiledit.svg" />
          <img
        ...
        <div className={styles.uileditContainer}>
          <img className={styles.uileditIcon2} alt="" src="/uiledit.svg" />
          <img
        ...
        <div className={styles.groupDiv}>
          <img className={styles.uileditIcon3} alt="" src="/uiledit.svg" />
          <img
        ...
        <div className={styles.uileditParent1}>
          <img className={styles.uileditIcon4} alt="" src="/uiledit.svg" />
          <img
        ...
        <div className={styles.uileditParent2}>
          <img className={styles.uileditIcon5} alt="" src="/uiledit.svg" />
          <img
        ...
        <div className={styles.uileditParent3}>
          <img className={styles.uileditIcon6} alt="" src="/uiledit.svg" />
          <img
        ...
        <div className={styles.uileditParent4}>
          <img className={styles.uileditIcon7} alt="" src="/uiledit.svg" />
          <img
        ...
        <div className={styles.groupContainer}>
          <div className={styles.sno12345678Wrapper}>
