...
function App() {
  ...
  return (
    <Routes>
      <Route path="/" element={<PollQuiz1 />} />
      <Route path="/loginsignup-error" element={<LoginSignupError />} />
      <Route path="/poll-quiz-image-text" element={<PollQuizImageText />} />
      <Route path="/qna-quiz" element={<QnAQuiz />} />
      <Route path="/poll-quiz" element={<PollQuiz />} />
      <Route path="/qna-quiz1" element={<QnAQuiz1 />} />
      <Route path="/poll-quiz1" element={<PollQuiz2 />} />
      <Route path="/poll-quiz2" element={<PollQuiz3 />} />
      <Route path="/qna-quiz2" element={<QnAQuiz2 />} />
      <Route path="/qna-quiz3" element={<QnAQuiz3 />} />
      <Route path="/poll-interface" element={<PollInterface />} />
      <Route path="/quiz-interface" element={<QuizInterface />} />
      <Route path="/poll-interface1" element={<PollInterface1 />} />
      <Route path="/quiz-interface1" element={<QuizInterface1 />} />
      <Route path="/poll-interface2" element={<PollInterface2 />} />
      <Route path="/poll-interface3" element={<PollInterface3 />} />
      <Route path="/poll-interface4" element={<PollInterface4 />} />
      ...
      <Route path="/loginsignup" element={<LoginSignup1 />} />
      <Route
      ...
      />
      <Route path="/quiz-link-share-page" element={<QuizLinkSharePage />} />
      <Route path="/quiz-link-share-page1" element={<QuizLinkSharePage1 />} />
      <Route
